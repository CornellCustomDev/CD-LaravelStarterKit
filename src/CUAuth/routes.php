...
Route::group(['middleware' => ['web']], function () {
    Route::get('/shibboleth-login', [ApacheShibController::class, 'shibbolethLogin'])->name('cu-auth.shibboleth-login');
    Route::get('/shibboleth-logout', [ApacheShibController::class, 'shibbolethLogout'])->name('cu-auth.shibboleth-logout');
